    ...
    if(!empty($_POST))
    {
        ...
        if(!isEmail($email))
        {
            ...
            if(emailExiste($email))
            {
                ...
                $url = 'http://'.$_SERVER["SERVER_NAME"].'/sistemaPHP/cambiaPass.php?id='.$user_id.'&token='.$token;
                ...
                {
                    echo "Hemos enviado un correo electornico a la direccion $email para restablecer su password. <br/>"; 
        ...
        {
            $errors[] = "No existe el correo electronico ingresado";
        }
    }
?>
...
<html lang="en">
    <head>
        ...
        <title>Restore Pass - SB Admin</title>
